                    ...
                    <div class="col-xl-12">
                        ...
                        <div class="card">
                            <div class="card-header align-items-center d-flex">
                                <h4 class="card-title mb-0 flex-grow-1">Trash All Categories</h4>
                                <div class="flex-shrink-0">
                                    <a href="{{ route('category.manage') }}" class="btn btn-soft-info btn-sm">View Manage</a>
                                </div>
                            </div><!-- end card header -->
